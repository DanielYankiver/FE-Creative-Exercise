      ...
      <div className="w-full h-screen bg-teal-700">
        ...
        <div className="flex justify-center content-center z-10">
          ...
          <div className="absolute left-72 top-44">
            <div className="text-teal-700 cursor-pointer md:border-4 rounded-lg w-10/12 md:w-1/2 lg:w-3/5 flex-col justify-center bg-white border-teal-500 hover:text-white hover:bg-teal-600 ">
