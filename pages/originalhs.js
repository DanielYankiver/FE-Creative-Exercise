          ...
          <form className='mx-8 my-16'>
            <div className='mb-4'>
              ...
              <div className='relative w-full'>
                ...
                <input className='text-sm justify-betweenborder rounded-md w-full h-10 py-2 px-3 text-gray-400 focus:outline-teal-500' id="username" type="show ? 'password' : 'text'" placeholder='Type something' />
              </div>
            </div>
            <div className='mt-8'>
